...
describe("Persistent Node Chat Server", function() {
            ...
            function () {
              ...
              dbConnection.query( queryString,
                function(err, results) {
                  console.log("results of retrieving msgs err: ", err);
                  console.log("results of retrieving msgs: " + JSON.stringify(results));
  ...
  it("Should output all messages from the DB", function(done) {
    ...
    var queryString = 'INSERT INTO messages (text, user_id, room_id) ';
    queryString +=    'VALUES ("Men like you can never change!",1,1)';
    //var queryArgs = [];
