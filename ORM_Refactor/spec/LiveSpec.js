...
describe("Persistent Node Chat Server", function() {
  ...
  it("Should output all messages from the DB", function(done) {
    ...
    var queryString = 'INSERT INTO messages (text, userid, roomname, createdAt, updatedAt) ';
    queryString +=    'VALUES ("Men like you can never change!",1,"main", "2014-10-04 02:14:54", "2014-10-04 02:14:54")';
    //var queryArgs = [];
